...
import { MainCard, CardTop, CardBottom, CardType, ButtonDeletePokemon, ImgLoading, ButtonAddPokemon, ImgPokemon } from "./styled";
...
export function Card(props) {
    ...
    return (
        <>
            ...
            {context.isLoading ? <ImgLoading src={pokeball} alt="Loading" />
                :
                <MainCard key={props.pokemon.id} cardColor={cardColor}>
                    ...
                    <CardTop>
                        ...
                        <div>
                            <ImgPokemon src={props.pokemon.sprites?.other['official-artwork'].front_default} alt="pokemon" />
                        </div>
                    </CardTop>
                    <CardBottom>
                        <span><a onClick={() => goToPokemonDetails(navigate, props.pokemon.name)}>Detalhes</a></span>
                        {location.pathname === "/" ?
                            <ButtonAddPokemon onClick={() => context.addPokemonPokedex(props.pokemon)}>Capturar!</ButtonAddPokemon>
                            :
